...
const translations = {
  es: {
    ...
    projects: {
      ...
      project4Desc: "Sitio web para una agencia de automóviles. Presenta el catálogo de vehículos con fichas detalladas y un panel de administración que, además de gestionar las publicaciones, ofrece métricas del negocio para seguir el rendimiento del stock y las consultas.",
      code: "Código",
      demo: "Demo",
    },
    skills: {
  ...
  en: {
    ...
    projects: {
      ...
      project4Desc: "Website for a car dealership. Showcases the vehicle catalog with detailed listings and an admin panel that, beyond managing the published units, provides business metrics to track inventory performance and inquiries.",
      code: "Code",
      demo: "Demo",
    },
    skills: {
